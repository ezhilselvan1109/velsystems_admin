      ...
      <div>
        ...
        <div className="space-y-4">
          {imageFields.map((field, index) => (
            <div key={field.id} className="border border-gray-200 rounded-lg p-3 sm:p-4 bg-white">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 gap-3 sm:gap-0">
                ...
                <button
                  ...
                  className="p-1.5 text-red-600 hover:bg-red-50 rounded transition-colors self-end sm:self-auto"
                >
          ...
          {imageFields.length === 0 && (
            <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
              <Package className="w-8 h-8 sm:w-10 sm:h-10 text-gray-400 mx-auto mb-2" />
